...
public class EditRoomWindow {
	...
	public void initialize() {
		...
		lblNewLabelValor.setBounds(64, 243, 183, 16);
		MainPanelEditRoom.add(lblNewLabelValor);
		...
		spinnerValorQuarto.setBounds(64, 271, 206, 22);
		MainPanelEditRoom.add(spinnerValorQuarto);
		...
		lblNewLabelMaxHospedes.setBounds(64, 326, 183, 16);
		...
		spinnerMaximoHospede.setBounds(64, 354, 206, 22);
	...
	private void RoomUpdate() {
		...
		try {
			...
			if (result > 0) {
				...
				JOptionPane.showMessageDialog(frameEditRoom, "Falha ao editar quarto.", "Erro",
						JOptionPane.ERROR_MESSAGE);
			}

		} catch (NumberFormatException e) {
			JOptionPane.showMessageDialog(frameEditRoom, "Por favor, insira valores numéricos válidos.",
					"Erro de Formato", JOptionPane.ERROR_MESSAGE);
		} catch (Exception e) {
			JOptionPane.showMessageDialog(frameEditRoom, "Erro ao editar quarto: " + e.getMessage(), "Erro",
					JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
		}
